...
let listElements = document.querySelectorAll(".nav__parent");
...
// Agrega / cambia la clase asignada al dar click al icon menu.
...
function isActive(elemnt, string) {
  return elemnt.classList.value.includes(string);
}
